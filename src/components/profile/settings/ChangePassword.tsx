                  ...
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-4">
                      ...
                      <input
                        ...
                        id="old_password"
                        required
                        className="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 border focus:border-indigo-500 sm:text-sm"
                        value={oldPass}
                    ...
                    <div className="col-span-6 sm:col-span-4">
                      ...
                      <input
                        ...
                        id="new_password"
                        required
                        className="block w-full mt-1 border-gray-300 border rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        value={newPass}
